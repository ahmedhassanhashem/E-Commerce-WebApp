...
<div id="app">
  <div class="fixed-list">
    <ul class="nav" id="init-scrollspy" style="background: #d3cece">
      <li>

        <a class="nav-link" href="#electronic-01" data-click-scroll="#electronic-01"><i><img src="images/nav-ico/beans.png" width="20" height="24"></i></a>
      </li>
      <li>

        <a class="nav-link" href="#female-02" data-click-scroll="#female-02"><i><img src="images/nav-ico/cups.png" width="20" height="24"></i></a></li>
      <li>

        <a class="nav-link" href="#male-03" data-click-scroll="#male-03"><i><img src="images/nav-ico/machines.png" width="20" height="24"></i></a></li>
    ...
    <div class="white-container">
      ...
      <div class="white-container">
        <div class="container">
          ...
          <!--====== Primary Slider ======-->
          <div class="s-skeleton s-skeleton--h-800 s-skeleton--bg-black">
                  ...
                  <div class="row">
                    <div class="col-12">
                      <div class="slider-content slider-content--animation">
                        ...
                        <span class="content-span-2 u-c-white">Coffee Bags</span>
                  ...
                  <div class="row">
                    <div class="col-12">
                      <div class="slider-content slider-content--animation">
                        ...
                        <span class="content-span-2 u-c-white">Coffee Mugs</span>

                        <span class="content-span-4 u-c-white">Starting At

                                                        <span class="u-c-brand">$50.00</span></span>
                  ...
                  <div class="row">
                    <div class="col-12">
                      <div class="slider-content slider-content--animation">
                        ...
                        <span class="content-span-2 u-c-white">Coffee Machines</span>


                        <span class="content-span-4 u-c-white">Starting At

                                                        <span class="u-c-brand">$200.00</span></span>
              ...
              <div class="row">
                <div class="col-lg-12">
                  <div class="block">
                    ...
                    <span class="block__title">Beans</span></div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="section__content">
            <div class="container">
              <div class="tab-content">
                ...
                <!--====== Beans Tab ======-->
                <div class="tab-pane fade show active" id="b-e-a">
                            ...
                            <div class="product-o__action-wrap">
                              <ul class="product-o__action-list">
                                ...
                                <li>
                                  ...
                                  <a data-modal="modal" data-modal-id="#add-to-cart" data-tooltip="tooltip" data-placement="top" title="Add to Cart"><i class="fas fa-shopping-bag"></i></a>
                                </li>
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="block">
                  ...
                  <span class="block__title">Mugs</span></div>
              </div>
            </div>
          </div>
        </div>
              ...
              <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 u-s-m-b-30">
                <div class="category-o">
                  <div class="aspect aspect--bg-grey aspect--square category-o__img-wrap">
                    ...
                    <img class="aspect__img category-o__img" src="images/product/electronic/product123.jpg" alt=""></div>
                  <div class="category-o__info">
              ...
              <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 u-s-m-b-30">
                <div class="category-o">
                  <div class="aspect aspect--bg-grey aspect--square category-o__img-wrap">
                    ...
                    <img class="aspect__img category-o__img" src="images/product/electronic/product135.jpg" alt=""></div>
                  <div class="category-o__info">
              ...
              <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 u-s-m-b-30">
                <div class="category-o">
                  <div class="aspect aspect--bg-grey aspect--square category-o__img-wrap">
                    ...
                    <img class="aspect__img category-o__img" src="images/product/electronic/product354.jpg" alt=""></div>
                  <div class="category-o__info">
              ...
              <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 u-s-m-b-30">
                <div class="category-o">
                  <div class="aspect aspect--bg-grey aspect--square category-o__img-wrap">
                    ...
                    <img class="aspect__img category-o__img" src="images/product/electronic/product312.jpg" alt=""></div>
                  <div class="category-o__info">
        ...
        <div class="section__content">
          <div class="container">
            <div class="tab-content">
              ...
              <!--====== Beans Tab ======-->
              <div class="tab-pane fade show active" id="c-u-p">
                <div class="slider-fouc">
                  <div class="owl-carousel tab-slider" data-item="4">
                    <div class="u-s-m-b-30">
                      <div class="product-o product-o--hover-on">
          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="block">
                ...
                <span class="block__title">Machines</span></div>
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 u-s-m-b-30">
              <div class="category-o">
                <div class="aspect aspect--bg-grey aspect--square category-o__img-wrap">
                  ...
                  <img class="aspect__img category-o__img" src="images/product/electronic/product523.jpg" alt=""></div>
                <div class="category-o__info">
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 u-s-m-b-30">
              <div class="category-o">
                <div class="aspect aspect--bg-grey aspect--square category-o__img-wrap">
                  ...
                  <img class="aspect__img category-o__img" src="images/product/electronic/product395.jpg" alt=""></div>
                <div class="category-o__info">
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 u-s-m-b-30">
              <div class="category-o">
                <div class="aspect aspect--bg-grey aspect--square category-o__img-wrap">
                  ...
                  <img class="aspect__img category-o__img" src="images/product/electronic/product423.jpg" alt=""></div>
                <div class="category-o__info">
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 u-s-m-b-30">
              <div class="category-o">
                <div class="aspect aspect--bg-grey aspect--square category-o__img-wrap">
                  ...
                  <img class="aspect__img category-o__img" src="images/product/electronic/product121.jpg" alt=""></div>
                <div class="category-o__info">
      ...
      <div class="section__content">
        <div class="container">
          <div class="tab-content">
            ...
            <!--====== Beans Tab ======-->
            <div class="tab-pane fade show active" id="m-a-c">
              <div class="slider-fouc">
                <div class="owl-carousel tab-slider" data-item="4">
                  <div class="u-s-m-b-30">
                    <div class="product-o product-o--hover-on">
            ...
            <div class="bp-mini bp-mini--img u-h-100">
              ...
              <div class="bp-mini__content">
                <div class="bp-mini__stat">
                                                    ...
                                                    <span class="bp-mini__stat-wrap">
                                                        ...
                                                        <span class="bp-mini__publish-date">
                                                            ...
                                                            <a>
                                                                ...
                                                                <span>17 April 2025</span></a></span></span>
                  ...
                  <span class="bp-mini__stat-wrap">
                                                        ...
                                                        <span class="bp-mini__author">
                                                            ...
                                                            <a href="#">hot coffee team</a></span></span>
                ...
                <div class="blog-t-w">
                  ...
                  <a class="gl-tag btn--e-transparent-hover-brand-b-2">Beans</a>

                  <a class="gl-tag btn--e-transparent-hover-brand-b-2">Cups</a>

                  <a class="gl-tag btn--e-transparent-hover-brand-b-2">Machines</a></div>
              </div>
            </div>
          </div>
